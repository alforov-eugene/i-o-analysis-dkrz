...
In this paper we analyse and present the pros and cons of different data structurese required by a some carefully picked climate and weather prediction models. Further we look at the absolute bare minimum of data required by those models by these models, to show how much data doesn't have to be stored
